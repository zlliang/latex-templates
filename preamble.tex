...
\usepackage[bf,sf]{titlesec}  % Section title format
...
% --- Page style
\pagestyle{plain}
\pretitle{\vspace{-2cm}\begin{flushleft}\bfseries\sffamily\LARGE}
\posttitle{\end{flushleft}}
\preauthor{\begin{flushleft}}
\postauthor{\end{flushleft}}
\predate{\begin{flushleft}}
\postdate{\end{flushleft}}
\renewenvironment{abstract}{\begin{tcolorbox}
  [colback=white,colframe=black,boxrule=0.2mm,sharp corners]
  \small{\bfseries\sffamily Abstract}\quad}{\end{tcolorbox}}
\newcommand{\keywords}[1]{\vspace{2mm}\par{\bfseries\sffamily Keywords}\quad{#1}}
